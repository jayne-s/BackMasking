 ...
 * each time a new node is added to the list through the use of the push() method in the
 * ListStack.java file. When multiple ListStackNodes are connected to one another using
